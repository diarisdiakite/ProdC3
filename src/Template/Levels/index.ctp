    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Levels</h3>
          <div class="box-tools">
            ...
            <?php foreach ($levels as $level): ?>
              <tr>
                ...
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $level->id], ['confirm' => __('Confirm to delete this entry?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
