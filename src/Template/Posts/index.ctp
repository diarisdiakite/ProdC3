          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  <a href="#" class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?= $post->has('type') ? $this->Html->link($post->type->name, ['controller' => 'Types', 'action' => 'view', $post->type->id]) : '' ?></small>
                    <?= $post->has('user') ? $this->Html->link($post->user->username, ['controller' => 'Users', 'action' => 'view', $post->user->id]) : '' ?>
                  
                  <td class="actions" style="white-space:nowrap">
                  <?= $this->Html->link(__('View post'), ['action' => 'view', $post->id], ['class'=>'btn btn-info btn-xs']) ?>
                  </td>
                  </a>
                  <br>
                  <?= h($post->title) ?>
