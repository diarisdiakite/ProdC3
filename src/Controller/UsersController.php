...
class UsersController extends AppController
{
    ...
    public function view($id = null)
    {
        $user = $this->Users->get($id, [
            'contain' => ['Activations', 'Administrators', 'Assignements', 'Assistants', 'Composants', 'Contacts', 'ExpectedResults', 'Experts', 'FinancesResponsibles', 'FocalPoints', 'Inserts', 'JobEmployments', 'Leashes', 'Ministries', 'Operations', 'Planifications', 'Posts', 'ProjectActions', 'Realizations', 'Secretaries', 'Sectors', 'Structures', 'Teams', 'Technicals', 'Types']
        ]);
