...
/**
 * MeetingSubjectsFixture
 *
 */
class MeetingSubjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'meeting_key' => ['type' => 'index', 'columns' => ['meeting_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'meeting_key' => ['type' => 'foreign', 'columns' => ['meeting_id'], 'references' => ['meetings', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'meeting_id' => 1,
                'created' => '2018-11-21 16:34:18',
                'modified' => '2018-11-21 16:34:18'
            ],
        ];
        parent::init();
    }
