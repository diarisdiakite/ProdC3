 ...
 *
 */
class InsertsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'planification_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'expected_result_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'date_year_key' => ['type' => 'index', 'columns' => ['date_year_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'date_year_key' => ['type' => 'foreign', 'columns' => ['date_year_id'], 'references' => ['date_years', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_year_id' => 1,
                'amount' => 1,
                'created' => '2018-11-21 16:33:26',
                'modified' => '2018-11-21 16:33:26'
            ],
        ];
        parent::init();
    }
