...
/**
 * ExpectedResultsFixture
 *
 */
class ExpectedResultsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'approved' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'composant_key' => ['type' => 'index', 'columns' => ['composant_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'composant_key' => ['type' => 'foreign', 'columns' => ['composant_id'], 'references' => ['composants', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-21 16:31:53',
                'modified' => '2018-11-21 16:31:53'
            ],
        ];
        parent::init();
    }
