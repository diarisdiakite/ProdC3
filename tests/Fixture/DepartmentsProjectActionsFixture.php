...
/**
 * DepartmentsProjectActionsFixture
 *
 */
class DepartmentsProjectActionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['department_id', 'project_action_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
