...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mission' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'ministry_key' => ['type' => 'foreign', 'columns' => ['ministry_id'], 'references' => ['ministries', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-21 16:31:32',
                'modified' => '2018-11-21 16:31:32'
            ],
        ];
        parent::init();
    }
