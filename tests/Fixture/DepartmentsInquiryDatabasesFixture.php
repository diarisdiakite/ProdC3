...
/**
 * DepartmentsInquiryDatabasesFixture
 *
 */
class DepartmentsInquiryDatabasesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['department_id', 'inquiry_database_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
