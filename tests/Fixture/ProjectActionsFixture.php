...
/**
 * ProjectActionsFixture
 *
 */
class ProjectActionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'expected_result_key' => ['type' => 'index', 'columns' => ['expected_result_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'expected_result_key' => ['type' => 'foreign', 'columns' => ['expected_result_id'], 'references' => ['expected_results', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'approved' => 1,
                'created' => '2018-11-21 16:36:09',
                'modified' => '2018-11-21 16:36:09'
            ],
        ];
        parent::init();
    }
