 ...
 *
 */
class RealizationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'insert_key' => ['type' => 'index', 'columns' => ['insert_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'insert_key' => ['type' => 'foreign', 'columns' => ['insert_id'], 'references' => ['inserts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'amount' => 1,
                'created' => '2018-11-21 16:36:19',
                'modified' => '2018-11-21 16:36:19'
            ],
        ];
        parent::init();
    }
