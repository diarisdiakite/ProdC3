 ...
 *
 */
class LeashesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'sector_key' => ['type' => 'index', 'columns' => ['sector_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'sector_key' => ['type' => 'foreign', 'columns' => ['sector_id'], 'references' => ['sectors', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-24 13:44:42',
                'modified' => '2018-11-24 13:44:42'
            ],
        ];
        parent::init();
    }
